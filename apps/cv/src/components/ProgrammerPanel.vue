...
const programmerLevels = [
    {
        ...
        points: [
            ...
            { text: '你已经掌握了多个横向领域的技术，能够超越技术栈给出适合项目的<u>技术方案</u>。', unlit: true },
            { text: '你对<u>软件质量</u>有深刻的理解，注重产品的稳定性、安全性和可维护性。' },
            { text: '你能够使用各种工具进行<u>静态分析</u>、<u>动态分析</u>和<u>代码审查</u>，以提高代码的质量和安全性。' },
            { text: '你总是能在代码评审中发现别人意识不到的细节问题。' },
            { text: '你会为项目制定合理的<u>量化指标</u>，并使用技术手段持续跟进防止劣化。', unlit: true },
            { text: '你可以为项目沉淀技术规范，制定最佳编码实践，提升项目整体的代码质量和编码效率。' },
            { text: '你在团队中发挥着<u>技术引导</u>作用，推动团队不断提升软件开发的质量和稳定性。' },
            { text: '你也会利用闲暇时间开发一些<u>开源</u>项目，或者有能力为一些著名的开源项目贡献代码。' },
            { text: '你也开始在一些场合<u>分享</u>自己的技术实践，尽管有时候你还不太习惯在很多人面前大声表达自己的意见。' },
    ...
    },
    {
        ...
        points: [
            ...
            { text: '你编写代码时开始小心翼翼，不仅关注程序<u>正确性</u>，还会关注程序的<u>性能</u>。' },
            { text: '你很清楚数据结构和算法对性能的影响，会选择合适的<u>算法</u>来提升程序的性能。', unlit: true },
            { text: '你对常见的<u>性能问题</u>有较深的理解，如内存泄漏、GC 垃圾回收、CPU 使用率等。' },
            { text: '你可以熟练运用常见的性能工具分析程序的<u>性能</u>瓶颈，并给出<u>优化</u>方案。' },
            { text: '你理解系统的各个组成部分，能够在实现新功能时考虑到系统整体的<u>架构</u>和<u>稳定性</u>。' },
            { text: '你开始看到散落的知识点之间产生美妙的连接，<u>知识体系</u>逐渐构建起来。' },
    ...
    },
    {
        ...
        points: [
            ...
            { text: '你已经开始注意<u>代码规范</u>和<u>代码质量</u>，并有意识地为程序增加更多的<u>可扩展性</u>。' },
            { text: '你开始不满足于表面的现象，并尝试深挖问题的本质。' },
            { text: '你开始意识到<u>基础知识</u>对探索问题的本源所带来影响。' },
