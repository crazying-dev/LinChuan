...
<template>
    <Content>
        ...
        <div class="MaxContainer flex flex-col text-black dark:text-white">
            <div class="overflow-x-auto text-center text-nowrap selection:bg-pink-300 selection:text-black md:text-2xl">
                <input
                    v-show="isEditing"
                    id="editor"
                    ref="editor"
                    ...
                    :class="
                        uuid
                            ? 'border-slate-300 hover:border-pink-500 dark:border-slate-500 dark:hover:border-pink-300'
                            : 'border-orange-400'
                    "
                    class="w-full rounded-lg border-2 bg-slate-200 p-4 text-center font-mono outline-0 dark:bg-slate-700"
                ...
                <div
                    v-show="!isEditing"
                    class="w-full rounded-lg border-2 border-transparent p-4 font-mono"
                    @dblclick="
                        isEditing = true;
            ...
            <div v-if="uuid" class="mt-4 overflow-x-auto">
                <div class="mx-auto flex w-fit flex-nowrap rounded-lg bg-white p-6 dark:bg-slate-800">
                    <div class="flex min-w-96 flex-col gap-y-4 text-center">
                    ...
                    <div
                        class="ml-4 space-y-3 border-l border-l-slate-200 pl-4 text-nowrap empty:hidden dark:border-l-slate-700"
                    >
                        <p v-if="uuid.timeUTC">
                            时刻<br />
                            <code class="bg-lime-500/50 dark:bg-lime-400/50" v-html="uuid.timestampSeconds" /><br />
                            <code v-html="uuid.timeUTC" /><br />
                            <code v-html="uuid.timeLocal" /><br />
                        </p>
                        ...
                        <div v-if="uuid.version === 3 || uuid.version == 5" class="flex flex-col gap-4">
                                ...
                                <input
                                    ...
                                    :class="
                                        UUID.parse(namespace)
                                            ? 'focus:border-b-pink-500 dark:focus:border-b-pink-300'
                                            : 'border-b-orange-400!'
                                    "
                                    class="w-full min-w-sm border-b-2 border-b-transparent font-mono text-nowrap outline-0 selection:bg-pink-300 selection:text-black"
                                    type="text"
                                />
                            </div>
                            <div>
                                ...
                                <input
                                    v-model="name"
                                    class="w-full min-w-sm border-b-2 border-b-transparent font-mono text-nowrap outline-0 selection:bg-pink-300 selection:text-black focus:border-b-pink-500 dark:focus:border-b-pink-300"
                                    type="text"
                                />
                            </div>
                            <div class="flex gap-3">
                                <AiButton
                                    inner
                                    text="UUID v3"
                                    @click="analysis(UUID.v3(name, UUID.parse(namespace)))"
                                />
                                <AiButton
                                    inner
                                    text="UUID v5"
                                    @click="analysis(UUID.v5(name, UUID.parse(namespace)))"
                                />
                            </div>
                        </div>
                    </div>
            ...
            <div class="overflow-x-auto">
                <table class="mx-auto rounded-lg bg-white text-nowrap dark:bg-slate-800">
                    ...
                    <tbody class="**:[td]:px-8 **:[td]:py-1.5">
                        <tr :class="uuid?.variant === UUID.NCS ? 'bg-slate-200 dark:bg-slate-700' : ''">
                            <td>
                                <code>0<span class="opacity-20">*** ****</span></code>
                            </td>
                            <td>
                        ...
                        <tr :class="uuid?.variant === UUID.RFC_4122 ? 'bg-slate-200 dark:bg-slate-700' : ''">
                            <td>
                                <code>10<span class="opacity-20">** ****</span></code>
                            </td>
                            <td>
                            ...
                            <td>
                                <a
                                    class="text-purple-700 hover:text-purple-400 dark:text-purple-400 dark:hover:text-purple-200"
                        ...
                        <tr :class="uuid?.variant === UUID.MICROSOFT ? 'bg-slate-200 dark:bg-slate-700' : ''">
                            <td>
                                <code>110<span class="opacity-20">* ****</span></code>
                            </td>
                        ...
                        <tr :class="uuid?.variant === UUID.FUTURE ? 'bg-slate-200 dark:bg-slate-700' : ''">
                            <td>
                                <code>111<span class="opacity-20">* ****</span></code>
                            </td>
                    ...
                    <tbody class="**:[td]:px-6 **:[td]:py-1.5">
                        ...
                        <tr :class="uuid?.version === 2 ? 'bg-slate-200 dark:bg-slate-700' : ''">
                            ...
                            <td>
                                ...
                                <span class="text-slate-500 dark:text-slate-400">
                                    UUIDv2。占用了 v1 时间戳部分比特位存放本地信息，若仅靠时钟变动，每 7 分钟又
                                    9.4967295 秒才能生成一个新的 UUID。
                                </span>
                            </td>
                        </tr>
