export const characters = [
    {
        ...
        abilities: [
            ...
            { scope: 'others', short: '无伤坠落(下落攻击)', talent: 'combat1' },
        ]
    }, {
        name: '胡桃',
        abilities: []
        ...
        name: '罗莎莉亚',
        abilities: [
            { scope: 'moving', short: '夜间', talent: 'passive3' },
        ]
    }, {
        name: '烟绯',
        abilities: [
        ...
        name: '流浪者',
        abilities: [
            { scope: 'others', short: '突破少花钱(弓,法器)', talent: 'passive3' },
        ]
    }, {
        name: '瑶瑶',
        abilities: [
        ...
        name: '闲云',
        abilities: [
            { scope: 'moving', short: '滑翔时', talent: 'passive3' },
        ]
    }, {
        name: '千织',
        abilities: [
            { scope: 'moving', short: '锦衣', talent: 'passive3' },
        ]
    }, {
        name: '阿蕾奇诺',
        abilities: []
        ...
        name: '基尼奇',
        abilities: [
            { scope: 'moving', short: '纳塔采集', talent: 'passive4' },
            { scope: 'moving', short: '战技落地后', constellation: 'c1' },
            { scope: 'locator', short: '区域特产', talent: 'passive4' },
        ]
    }, {
        name: '希诺宁',
        ...
        name: '欧洛伦',
        abilities: [
            { scope: 'moving', short: '滑翔时', talent: 'passive4' },
        ]
    }, {
        name: '恰斯卡',
        abilities: [
            { scope: 'stamina', short: '脱战夜魂', constellation: 'c1' },
        ]
    }, {
        name: '茜特菈莉',
        abilities: [
            { scope: 'stamina', short: '腾跃,瞄准,重击', constellation: 'c1' },
        ]
    }, {
        name: '玛薇卡',
        abilities: []
        ...
        name: '伊安珊',
        abilities: [
            { scope: 'others', short: '无伤坠落(纳塔)', talent: 'passive3' },
        ]
    }, {
        name: '瓦雷莎',
        abilities: [
            { scope: 'moving', short: '冲刺更快', talent: 'passive4' },
            { scope: 'others', short: '无伤坠落(纳塔)', talent: 'passive3' },
        ]
    }, {
        name: '伊法',
        abilities: [
            { scope: 'stamina', short: '脱战夜魂', constellation: 'c6' },
        ]
    }, {
        name: '爱可菲',
        abilities: []
